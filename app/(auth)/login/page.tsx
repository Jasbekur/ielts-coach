            ...
            {step === "email" ? (
              ...
              <>
                <CardTitle className="text-base flex items-center gap-2">
                  <Mail className="w-4 h-4 text-violet-500" /> Enter your code
                </CardTitle>
                <CardDescription className="text-xs">
                  Sent a 6-digit code to <strong>{email}</strong>. Check inbox + spam.
                </CardDescription>
              </>
            )}
          </CardHeader>
                ...
                <form onSubmit={handleSendOtp} className="space-y-3">
                  ...
                  <Button type="submit" className="w-full gap-2" disabled={loading}>
                    {loading ? (
                      ...
                      <>
                        <Mail className="w-4 h-4" /> Send sign-in code
                      </>
                    )}
                  </Button>
                </form>
